...
void main() {
  ...
  gl_FragColor = color;
      ...
      // The section can change height after mount (web fonts swapping in
      // reflow the copy), which never fires a window resize and would leave
      // iResolution stale, skewing where the rays land.
